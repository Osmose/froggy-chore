    ...
    post(url, params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (response.ok) {
                ...
                throw new Error(response.status, `POST ${url} failed: ${response.status} ${response.statusText}`);
            }
        });
    },
    getList(listId) {
...
function makeChores() {
    ...
    return {
        ...
        load(listId) {
            return __awaiter(this, void 0, void 0, function* () {
                try {
                    setChores(yield api.getList(listId));
                    setListId(listId);
                    setCreated(false);
                }
                catch (err) {
        ...
        create() {
            return __awaiter(this, void 0, void 0, function* () {
                const listId = uuidv4();
                const chores = [];
                yield api.postList(listId, chores);
                setChores([]);
                setListId(listId);
                setCreated(true);
        ...
        add(name, delay) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                yield api.postList(listId, newChores);
                setChores(newChores);
            });
        },
        remove(name) {
        ...
        complete(name) {
            return __awaiter(this, void 0, void 0, function* () {
                const newChores = chores.map(chore => {
                    ...
                    return Object.assign(Object.assign({}, chore), { lastDone: new Date() });
                });
                yield api.postList(listId, newChores);
                setChores(newChores);
        ...
        postpone(name) {
            return __awaiter(this, void 0, void 0, function* () {
                const newChores = chores.map(chore => {
                    ...
                    return Object.assign(Object.assign({}, chore), { lastDone: newLastDone });
                });
                yield api.postList(listId, newChores);
                setChores(newChores);
                playInn();
...
function ListView() {
    ...
    function handleClickDone(chore) {
        return __awaiter(this, void 0, void 0, function* () {
            yield complete(chore.name);
        });
    }
    function handleClickDelete(chore) {
        return __awaiter(this, void 0, void 0, function* () {
            yield remove(chore.name);
        });
    }
    function handleClickPostpone(chore) {
        return __awaiter(this, void 0, void 0, function* () {
            yield postpone(chore.name);
        });
    }
    if (chores === undefined) {
